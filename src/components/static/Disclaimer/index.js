...
const Disclaimer = () => {
  ...
  return (
    <Container className={classes.root}>
      ...
      <Box>
        <Typography variant='body2'>
          he words of which the initial letter is capitalized have
      ...
      <Box>
        <Typography variant='h6'>Defination</Typography>
        <Typography variant='body2'>---------------</Typography>
      </Box>
      <Box>
        <Typography variant='body2'>
          For the purposes of the Disclaimer:
        </Typography>
        <Box>
          <Typography variant='body2'>
            * Company (referred to as either “the Company”, “We”, “Us”
            or “Our” in this Disclaimer) refers to Botte, Sheffield,
            England.
          </Typography>
          <Typography variant='body2'>
          ...
          <Typography variant='body2'>
            ...
            company, or other egal entity on behalf of which such
            individual is accessing or using the Service, as
            applicable.
          </Typography>
          <Typography variant='body2'>
            Website refers to Botte, accessible from
            http://www.botte.co.uk
          </Typography>
        </Box>
      </Box>
      <Box>
      ...
      <Box>
        <Typography variant='h6'>Fair Use Disclaimer</Typography>
        <Typography variant='body2'>===============</Typography>
      </Box>
      <Box>
        <Typography variant='body2'>
